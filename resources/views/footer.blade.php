...
{{--<div class="row align-center padding-top-bottom-30">--}}
    {{--<span class="copyright">© Copyright 2015 <a--}}
                {{--href="http://themeforest.net/item/renovate-construction-renovation-template/11313006?ref=QuanticaLabs"--}}
                {{--title="Renovate Template" target="_blank">Renovate Template</a> by <a href="http://quanticalabs.com"--}}
                                                                                      {{--title="QuanticaLabs"--}}
                                                                                      {{--target="_blank">QuanticaLabs</a></span>--}}
{{--</div>--}}
