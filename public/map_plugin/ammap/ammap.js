...
(function () {
    ...
    d.parseDefs = function (a, b) {
        for (var c in a) {
            var e = typeof a[c];
            if (0 < a[c].length && "object" == e)for (var f = 0; f < a[c].length; f++)e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c][f],
...
(function () {
    ...
    d.drop = function (a, b, c, e, d, g, h, k) {
        var l = 1 / 180 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, p = Math.cos(m * l) * b,
            t = Math.sin((m + 40) * l) * b, r = Math.cos((m + 40) * l) * b, q = .8 * b, y = -b / 3, B = b / 3;
        0 === c && (y = -y, B = 0);
        180 == c && (B = 0);
        90 == c && (y = 0);
        270 == c && (y = 0, B = -B);
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.position, b = this.marginLeft +
                ...
                n = this.spacing, p = k - c - b, t = 0, r = 0, q = this.container;
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                n || (n = b.customMarker);
                var p = b.container, t = b.markerSize, r = 0, q = 0, y = t / 2;
                if (e) {
                    e = a.type;
                    b.switchType = void 0;
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e) m = p.set(), a.hidden || (g = a.lineColorR, k = a.bulletBorderColorR), r = d.line(p, [0, 2 *
                    t], [t / 2, t / 2], g, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(c, r, "graph-stroke"), m.push(r), a.bullet && (a.hidden || (g = a.bulletColorR), r = d.bullet(p, a.bullet, a.bulletSize, g, a.bulletAlpha, a.bulletBorderThickness, k, a.bulletBorderAlpha)) && (d.setCN(c, r, "graph-bullet"), r.translate(t + 1, t / 2), m.push(r)), y = 0, r = t, q = t / 3; else {
        ...
        animateMap: function () {
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if (a = b.mapContainer) {
                    ...
                    var m = b.realHeight,
                        n = b.realWidth, p = b.mapWidth, t = b.mapHeight;
                    b.mouseIsDown && b.dragMap && (3 < Math.abs(b.previuosMouseX - b.mouseX) || 3 < Math.abs(b.previuosMouseY - b.mouseY)) && (b.isDragging = !0);
                    if (!isNaN(k)) {
                        b.stopDrag();
                        var r = Math.sqrt(Math.pow(k - f, 2) + Math.pow(l - g, 2)), q = b.initialDistance;
                        isNaN(q) && (q = Math.sqrt(Math.pow(k - f, 2) + Math.pow(l - g, 2)));
                        if (!isNaN(q)) {
                            var k = b.initialTouchZoom * r / q, k = d.fitToBounds(k, h.minZoomLevel, h.maxZoomLevel),
                                h = b.zoomLevel(), q = b.middleXP, l = b.middleYP, r = m / t, y = n / p,
    ...
    d.ZoomControl = d.Class({
        construct: function (a) {
            ...
            var f = c.buttonSize, g = c.zoomControlEnabled, h = c.panControlEnabled, k = c.buttonFillColor,
                ...
                n = c.buttonBorderColor, p = c.buttonBorderAlpha, t = c.buttonCornerRadius, r = c.buttonRollOverColor,
    ...
    d.AreasProcessor = d.Class({
        construct: function (a) {
            ...
            var g = e.color, h = e.alpha, k = e.outlineThickness, l = e.rollOverColor, m = e.selectedColor,
                n = e.rollOverAlpha, p = e.rollOverBrightness, t = e.outlineColor, r = e.outlineAlpha,
...
(function () {
    ...
    d.AreasSettings = d.Class({
        construct: function (a) {
            ...
            this.selectedColor = this.rollOverOutlineColor = "#009ee3";
    ...
    d.ImagesProcessor = d.Class({
        construct: function (a) {
            ...
            var k = h.color, l = h.alpha, m = h.rollOverColor, n = h.rollOverOutlineColor, p = h.selectedColor,
                t = h.balloonText, r = h.outlineColor, q = h.outlineAlpha, y = h.outlineThickness, B = h.selectedScale,
    ...
    d.LinesProcessor = d.Class({
        construct: function (a) {
            ...
            var c = this.chart, e = c.linesSettings, f = this.objectsToResize, g = c.mapLinesContainer,
                ...
                p = e.arrowColor, t = e.arrowAlpha, r = e.color, q = e.alpha, y = e.rollOverColor, B = e.selectedColor,
...
(function () {
    ...
    d.normalizePath = function (a) {
        for (var b = "", c = d.parsePath(a.getAttribute("d")), e, f, g = Infinity, h = -Infinity, k = Infinity, l = -Infinity, m = 0; m < c.length; m++) {
            var n = c[m], p = n.letter, t = n.x, n = n.y;
            "h" == p && (p = "L", t += e, n = f);
            "H" == p && (p = "L", n = f);
            "v" == p && (p = "L", t = e, n += f);
            "V" == p && (p = "L", t = e);
    ...
    d.winkel3.invert = function (a, b) {
        ...
        do var h = Math.cos(e), k = Math.sin(e),
            l = Math.sin(2 * e), m = k * k, n = h * h, p = Math.sin(c), t = Math.cos(c / 2), r = Math.sin(c / 2),
            q = r * r, y = 1 - n * t * t, B = y ? d.acos(h * t) * Math.sqrt(u = 1 / y) : u = 0, u,
            y = .5 * (2 * B * h * r + c / g) - a, w = .5 * (B * k + e) - b,
            v = .5 * u * (n * q + B * h * t * m) + .5 / g, A = u * (p * l / 4 - B * k * r),
            k = .125 * u * (l * r - B * k * n * p), m = .5 * u * (m * t + B * q * h) + .5, h = A * k - m * v,
