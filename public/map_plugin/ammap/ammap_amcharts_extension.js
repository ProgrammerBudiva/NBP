(function () {
    ...
    e.AmMap = e.Class({
        ...
        animateMap: function () {
            ...
            var a = this.initialScale, b = this.initialX, c = this.initialY, d = this.tweenPercent,
            ...
            if (e.isModern) {
                ...
                if (!a.preventHover) {
                    ...
                    isNaN(c) || isNaN(d) || !(3 < Math.abs(b.x - c) || 3 < Math.abs(b.y - d)) || (a.mapWasDragged = !0, b = {
                        type: "dragCompleted",
                        zoomX: a.zoomX(),
                        zoomY: a.zoomY(),
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if (a = b.mapContainer) {
                    ...
                    if (!isNaN(k)) {
                        ...
                        if (!isNaN(q)) {
                            var k = b.initialTouchZoom * t / q, k = e.fitToBounds(k, g.minZoomLevel, g.maxZoomLevel),
                                g = b.zoomLevel(), q = b.middleXP, l = b.middleYP, t = m / r, u = n / p,
                                q = (b.zoomX() - q * u) * (k / g) + q * u, l = (b.zoomY() -
                                    l * t) * (k / g) + l * t;
        ...
        returnInitialColorReal: function (a) {
            ...
            var f = this.realWidth, h = this.realHeight,
                g = this.mapSet.scale, k = this.zoomControl,
                f = e.fitToBounds(c / f > d / h ? .8 * f / (c * g) : .8 * h / (d * g), k.minZoomLevel, k.maxZoomLevel);
            this.zoomToMapXY(f, (a + c / 2) * g, (b + d / 2) * g)
        }, zoomToLatLongRectangle: function (a, b, c, d) {
            var f = this.dataProvider, h = this.zoomControl, g = Math.abs(c - a), k = Math.abs(b - d),
                l = Math.abs(f.rightLongitude - f.leftLongitude), f = Math.abs(f.topLatitude - f.bottomLatitude),
                h = e.fitToBounds(g / l > k / f ? .8 * l / g : .8 * f / k, h.minZoomLevel, h.maxZoomLevel);
            ...
            if (a) {
                ...
                var d = a.zoomLevel, f = this.zoomInstantly, h = a.zoomX, g = a.zoomY, k = this.realWidth,
                    l = this.realHeight;
            ...
            void 0 == f && (f = "");
            var h = b.value, h = isNaN(h) ? "" : e.formatNumber(h, c), c = b.percents,
                c = isNaN(c) ? "" : e.formatNumber(c, d), d = b.description;
            void 0 == d && (d = "");
            var g = b.customData;
            void 0 == g && (g = "");
        ...
        checkIfClickable: function (a) {
            ...
            if (a.description) {
                ...
                var c = a.descriptionWindowWidth, d = a.descriptionWindowHeight, f = a.descriptionWindowLeft,
            ...
            for (var c = 0; c < b.length; c++) {
                ...
                if (d) {
                    for (var d = d.split("L"), f = [], e = 0; e < d.length; e++)if (d[e]) {
                        var g = d[e].split(" "),
                            g = this.xyToCoordinates(Number(g[1]) - this.minMapX, Number(g[2]) - this.minMapY, this.dpProjectionFunction, this.sourceMapWidth, this.sourceMapHeight);
            ...
            for (var b = !1, c = "", d = 0; d < a.length; d++) {
                var f = a[d][0], h = a[d][1], g = e.degreesToRadians(a[d][0]), k = e.degreesToRadians(a[d][1]),
                    k = this.projectionFunction(g, k), g = e.roundTo(this.x2c(e.radiansToDegrees(k[0])), 3),
                ...
                k < this.minMapYY && (this.minMapYY = k, this.topLongLat = {longitude: f, latitude: h});
            ...
            var a = e.degreesToRadians(this.dataProvider.leftLongitude),
                ...
                d = e.degreesToRadians(this.dataProvider.bottomLatitude), f = a + (b - a) / 2, h = c + (d - c) / 2,
                g = this.dpProjectionFunction(f,
                    c)[1], k = this.dpProjectionFunction(f, d)[1], l = this.dpProjectionFunction(a, h)[0],
                m = this.dpProjectionFunction(b, h)[0], c = e.equirectangular(f, c), d = e.equirectangular(f, d),
                g = (c[1] - d[1]) / (g - k), a = e.equirectangular(a, h), b = e.equirectangular(b, h),
                l = (a[0] - b[0]) / (l - m);
            ...
            var a = e.degreesToRadians(this.dataProvider.leftLongitude),
                ...
                c = e.degreesToRadians(this.dataProvider.topLatitude),
                d = e.degreesToRadians(this.dataProvider.bottomLatitude), f = a + (b - a) / 2, h = c + (d - c) / 2,
                g = this.dpProjectionFunction(f, c)[1], k = this.dpProjectionFunction(f, d)[1],
                l = this.dpProjectionFunction(a,
                    h)[0], m = this.dpProjectionFunction(b, h)[0];
            ...
            c = h = Infinity;
            for (d = 0; d < this.svgAreas.length; d++)f = this.svgAreas[d].getBBox(), f.y < h && (h = f.y), f.x < c && (c = f.x);
            this.diffY =
                b.y / this.mapScale - h;
        ...
        stageXYToCoordinates: function (a, b) {
            ...
            if (h = c.invert) {
                var g = this.dataProvider.leftLongitude, k = this.dataProvider.rightLongitude,
                    l = this.dataProvider.topLatitude, m = this.dataProvider.bottomLatitude,
                    n = g + (k - g) / 2, p = l + (m - l) / 2,
                    l = e.radiansToDegrees(c(e.degreesToRadians(n), e.degreesToRadians(l))[1]),
                    m = e.radiansToDegrees(c(e.degreesToRadians(n), e.degreesToRadians(m))[1]),
                    g = e.radiansToDegrees(c(e.degreesToRadians(g), e.degreesToRadians(p))[0]),
...
(function () {
    ...
    e.ZoomControl = e.Class({
        construct: function (a) {
            ...
            var f = c.buttonSize, h = c.zoomControlEnabled, g = c.panControlEnabled, k = c.buttonFillColor,
                ...
                q = c.gridHeight, u = c.zoomFactor, C = c.minZoomLevel, v = c.maxZoomLevel, D = c.buttonIconAlpha,
                y = c.buttonIconColor, E = c.roundButtons, z = a.svgIcons, w = a.getX(c.left), x = a.getY(c.top);
    ...
    e.SmallMap = e.Class({
        construct: function (a) {
            ...
            if (c.enabled) {
                ...
                d.push(f);
                c.buildSVGMap();
                var h = c.borderThickness, g = c.borderColor,
                    k = e.rect(b, c.width + h, c.height + h, c.backgroundColor, c.backgroundAlpha, h, g, c.borderAlpha);
            ...
            if (a) {
                var b = a.zoomLevel(), c = this.width, d = this.height, f = c / (a.realWidth * b),
                    e = a.mapContainer.getBBox(), c = c / b, d = d / b, g = this.rectangle;
                g.translate(-(a.mapContainer.x + e.x * b) * f + this.dx, -(a.mapContainer.y + e.y * b) * f + this.dy);
...
(function () {
    ...
    e.AreasProcessor = e.Class({
        construct: function (a) {
            ...
            for (d = 0; d < c; d++)if (e = a[d], e.value = Number(e.value), e = e.value, !isNaN(e)) {
                if (!1 === g || g < e) g = e;
                if (!1 === k || k > e) k = e;
                h += Math.abs(e);
                l++
            ...
            b.maxValueReal =
                g;
            b.minValueReal = k;
            for (d = 0; d < c; d++)e = a[d], isNaN(e.value) ? e.percents = void 0 : (e.percents = (e.value - k) / h * 100, k == g && (e.percents = 100));
            for (d = 0; d < c; d++)e = a[d], this.createArea(e);
            b.outlinesToFront()
        }, updateAllAreas: function () {
            var a = this.chart, b = a.areasSettings, c = b.unlistedAreasColor, d = b.unlistedAreasAlpha,
                f = b.unlistedAreasOutlineColor, h = b.unlistedAreasOutlineAlpha, g = a.svgAreas, k = a.dataProvider,
                l = k.areas, m = {}, n;
            ...
            var h = d.color, g = d.alpha, k = d.outlineThickness, l = d.rollOverColor, m = d.selectedColor,
                n = d.rollOverAlpha, p = d.rollOverBrightness, r = d.outlineColor, t = d.outlineAlpha,
                q = d.balloonText, u = d.selectable, C = d.pattern, v = d.rollOverOutlineColor,
                D = d.bringForwardOnHover, y = d.preserveOriginalAttributes;
...
(function () {
    ...
    e.ImagesProcessor = e.Class({
        construct: function (a) {
            ...
            var c = this.chart, d = c.container, f = c.mapImagesContainer, h = c.stageImagesContainer,
                g = c.imagesSettings;
            a.remove && a.remove();
            var k = g.color, l = g.alpha, m = g.rollOverColor, n = g.rollOverOutlineColor, p = g.selectedColor,
                r = g.balloonText, t = g.outlineColor, q = g.outlineAlpha, u = g.outlineThickness, C = g.selectedScale,
                v = g.rollOverScale, D = g.selectable, y = g.labelPosition, E = g.labelColor, z = g.labelFontSize,
                w = g.bringForwardOnHover, x = g.labelRollOverColor, F = g.rollOverBrightness, B = g.selectedLabelColor;
            a.index = b;
            a.chart = c;
            ...
            a || void 0 == g || (A && A.setAttr("fill", g), H = a.selectedLabelColorReal);
            A = null;
            void 0 !== a.label && (A = e.text(d, a.label, H, c.fontFamily, a.labelFontSizeReal, a.labelAlign), e.setCN(c, A, "map-image-label"), void 0 !== a.id && e.setCN(c, A, "map-image-label-" + a.id), H = a.labelBackgroundAlpha, (k = a.labelBackgroundColor) && 0 < H && (l = A.getBBox(), d = e.rect(d, l.width + 16, l.height + 10, k, H), e.setCN(c, d, "map-image-label-background"), void 0 != a.id && e.setCN(c, d, "map-image-label-background-" + a.id), G.push(d), a.labelBG = d), a.imageLabel = A, G.push(A),
                e.setCN(c, G, "map-image-container"), void 0 != a.id && e.setCN(c, G, "map-image-container-" + a.id), this.labelsToReposition.push(a), a.arrays.push({
            ...
            d ? h.push(G) : f.push(G);
            G.toBack();
            G && (G.rotation = a.rotation, isNaN(a.rotation) || G.rotate(a.rotation), a.arrays.push({
                arr: this.allSvgObjects,
                el: G
            }), this.allSvgObjects.push(G));
            this.allObjects.push(a);
            ...
            var k = a.longitude, l = a.latitude, m = a.positionOnLine, g = a.imageLabel, n = this.chart.zoomLevel(), p,
                r;
    ...
    e.LinesProcessor = e.Class({
        construct: function (a) {
            ...
            var c = this.chart, d = c.linesSettings, f = this.objectsToResize, h = c.mapLinesContainer,
                g = c.stageLinesContainer, k = d.thickness, l = d.dashLength, m = d.arrow, n = d.arrowSize,
                p = d.arrowColor, r = d.arrowAlpha, t = d.color, q = d.alpha, u = d.rollOverColor, C = d.selectedColor,
                v = d.rollOverAlpha, D = d.balloonText, y = d.bringForwardOnHover, E = d.arc, z = d.rollOverBrightness,
                w = c.container;
            a.chart = c;
            a.baseSettings = d;
            var x = w.set();
...
(function () {
    var e = window.AmCharts;
    e.MapArea = e.Class({
        inherits: e.MapObject, construct: function (a) {
            this.cname = "MapArea";
...
(function () {
    ...
    e.winkel3.invert = function (a, b) {
        ...
        do var g = Math.cos(d), k = Math.sin(d),
            l = Math.sin(2 * d), m = k * k, n = g * g, p = Math.sin(c), r = Math.cos(c / 2), t = Math.sin(c / 2),
            q = t * t, u = 1 - n * r * r, C = u ? e.acos(g * r) * Math.sqrt(v = 1 / u) : v = 0, v,
            u = .5 * (2 * C * g * t + c / h) - a, D = .5 * (C * k + d) - b,
            y = .5 * v * (n * q + C * g * r * m) + .5 / h, E = v * (p * l / 4 - C * k * t),
            k = .125 * v * (l * t - C * k * n * p), m = .5 * v * (m * r + C * q * g) + .5, g = E * k - m * y,
            E = (D * E - u * m) / g, u = (u * k - D * y) / g, c = c - E,
...
(function () {
    var e = window.AmCharts;
    e.MapData = e.Class({
        inherits: e.MapObject, construct: function () {
            this.cname = "MapData";
    ...
    e.ValueLegend = e.Class({
        construct: function (a) {
            ...
            if (this.enabled) {
                ...
                var g = 0, k = this.minValue, l = this.fontSize, m = a.fontFamily, n = this.color, p = {
